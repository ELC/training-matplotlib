...
To test this program the input and expected output are provided in the
...
class Deck(object):
    ...
    def is_shuffled(self):
        """Return True if the last two cards correctly shuffled, False
        otherwise."""
...
class Card(object):
    """A pair of Value-Type where Value can be from 0 to 12 and type can be
    "p", "c", "o" or "e". """
